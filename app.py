...
# --- Aplicação dos filtros do DataFrame ---
...
# --- Conteúdo Principal ---
st.title("👁️‍🗨️ Dashboard de Análise de Salários na Área de Dados")
...
if not df_filtrado.empty:
    ...
    salario_medio, salario_minimo, salario_maximo, total_registros, cargo_mais_comum = 0, 0, 0, ""

col1, col2, col3, col4, col5 = st.columns(5)
col1.metric("Salário médio", f"${salario_medio:,.0f}")
col2.metric("Salário mínimo", f"${salario_minimo:,.0f}")
